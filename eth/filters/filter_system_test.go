...
func (b *testBackend) SubscribeNewBlockEvent(ch chan<- core.NewBlockEvent) event.Subscription {
	return nil
}
...
func (b *testBackend) GetTxTimeRecord(txHash common.Hash) *types.TxTimeRecord {
	return nil
}

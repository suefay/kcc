...
func (b *filterBackend) GetPoolTransaction(txHash common.Hash) *types.Transaction {
	return nil
}
...
func (fb *filterBackend) SubscribeNewBlockEvent(ch chan<- core.NewBlockEvent) event.Subscription {
	return nil
}

...
func (ec *Client) CallContractEx(ctx context.Context, msg ethereum.CallMsg, blockNumber *big.Int, debug bool, needLogs bool) ([]byte, error) {
	var hex hexutil.Bytes
	err := ec.c.CallContext(
		ctx, &hex, "eth_callEx", toCallArg(msg),
